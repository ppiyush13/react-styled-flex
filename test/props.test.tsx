...
const flexBoxCases = [
  ...
  [
    { center: true, justifyContent: 'space-between' },
...
describe('testing all the exports of react-styled-flex', () => {
  /* test Box props */
  it.each([...boxCases])(
    'box: should render component with %o props',
    (props, styleMatch) => {
  ...
  it.each([...boxCases, ...flexBoxCases])(
    'flexBox: should render component with %o props',
    (props, styleMatch) => {
  ...
  it.each([...boxCases, ...flexBoxCases, ...flexItemCases])(
    'flexItem: should render component with %o props',
    (props, styleMatch) => {
  ...
  it.each([...flexBoxCases])(
    'flexItem: should not apply flexBox props when box is false, with %o props',
    (props, styleMatch) => {
